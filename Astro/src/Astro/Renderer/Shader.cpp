...
namespace Astro {
	...
	Astro::Ref<Astro::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Astro::Ref<Astro::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Astro::Ref<Astro::Shader> ShaderLibrary::Get(const std::string& name)
	{
